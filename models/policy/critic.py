...
class CriticMLP(nn.Module):
    def __init__(self, privilege_obs_dim, cfg_network, device='cuda:0'):
        super(CriticMLP, self).__init__()

        self.device = device

        self.layer_dims = [privilege_obs_dim] + cfg_network['critic_mlp']['units'] + [1]
        ...
        self.privilege_obs_dim = privilege_obs_dim
